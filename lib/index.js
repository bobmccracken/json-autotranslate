...
commander_1["default"]
    ...
    .parse(process.argv);
var translate = function (inputDir, cacheDir, sourceLang, deleteUnusedStrings, fileType, dirStructure, fixInconsistencies, service, matcher, decodeEscapes, config) {
            ...
            switch (_f.label) {
                ...
                case 1:
                    ...
                    _loop_3 = function (language) {
                        var translateContent, _a, existingFiles, templateFileNames_1, deletableFiles, _i, deletableFiles_1, file, cacheFile, _loop_4, _b, templateFiles_2, templateFile, _c, addedTranslations, removedTranslations;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                ...
                                case 6: return [4 /*yield*/, translateContent(templateFiles.find(function (f) { return f.name === sourceLang + ".json"; }), templateFiles.find(function (f) { return f.name === language + ".json"; }))];
                                case 7:
...
translate(commander_1["default"].input, commander_1["default"].cacheDir, commander_1["default"].sourceLanguage, commander_1["default"].deleteUnusedStrings, commander_1["default"].type, commander_1["default"].directoryStructure, commander_1["default"].fixInconsistencies, commander_1["default"].service, commander_1["default"].matcher, commander_1["default"].decodeEscapes, commander_1["default"].config)["catch"](function (e) {
    console.log();
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (service !== 'dry-run') {
                        ...
                        fs.writeFileSync(path.resolve(file_system_1.evaluateFilePath(workingDir, dirStructure, targetLang), destinationFile.name), newContent);
                        ...
                        fs.writeFileSync(path.resolve(languageCachePath, destinationFile.name), JSON.stringify(translatedFile, null, 2) + '\n');
                    }
